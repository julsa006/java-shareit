...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(long userId, CreateItemDto requestDto) {
    ...
    public ResponseEntity<Object> createComment(long userId, long itemId, CreateCommentDto requestDto) {
